...
const data = {
  En: ["Hi! I'm Quentin", "I am a Frontend Developer passionate about creating stunning experiences for my users"],
  Fr: ["Bonjour! Je m'appele Quentin", "Je suis un développeur frontend passionné par la création d'expériences époustouflantes pour mes utilisateurs"]
}
